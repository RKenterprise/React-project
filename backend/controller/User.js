...
// This if for update User Details
export const updateUser = async (req, res) => {
    try {
        ...
        if (about) {
            ...
            if (about.zaigs) {
                await cloudinary.v2.uploader.destroy(user.about.zaigs.public_id);

                const myCloud = await cloudinary.v2.uploader.upload(about.zaigs, {
                    folder: "portfolio",
                });
...
//This is for delete timeline from timelines
export const deleteTimeline = async (req, res) => {
    try {
        ...
        res.status(200).json({
            success: true,
            message: "Deleteded from Timeline!",
        });
    } catch (error) {
        return res.status(400).json({
            success: false,
...
//This is for delete project from projects
export const deleteProject = async (req, res) => {
    try {
        ...
        res.status(200).json({
            success: true,
            message: "Deleteded from Projects!",
        });
    } catch (error) {
        return res.status(400).json({
            success: false,
